/*
 *       to compile:   mex spharm_local_smoothing.c -lmwlapack
 */
...
#define LWSIZE 256000
#define SVSIZE 256000
...
void local_smooth(char *InName, char *OutName)
{
	...
	put_vector_values("_sphermap.metric",metric,METRICNUM);  /* put metric value into file */
